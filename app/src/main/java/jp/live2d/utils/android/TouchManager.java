...
public final class TouchManager {
	 ...
	 * @param y2
	 */
	public final void touchBegan(float x1, float y1, float x2, float y2) {
	 ...
	 * @param y
	 */
	public final void touchesMoved(float x, float y) {
		lastX = x;
		lastY = -y;
		lastTouchDistance = -1;
		touchSingle = true;
	 ...
	 * @return
	 */
	public final float getFlickDistance() {
		return distance(startX, startY, lastX, lastY);
	}

	public final boolean isSingleTouch() {
		return touchSingle;
	}

	public final boolean isFlickAvailable() {
		return flipAvailable;
	}

	public final void disableFlick() {
		flipAvailable = false;
	}
}